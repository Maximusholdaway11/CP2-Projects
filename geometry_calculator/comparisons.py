...
def higher_perimeter(shape_1, shape_2):
    ...
    if perimeter_1 > perimeter_2:
        print(f"{shape_1}'s perimeter is bigger than {shape_2}'s perimeter.")
    elif perimeter_2 > perimeter_1:
        print(f"{shape_2}'s perimeter is bigger than {shape_1}'s perimeter.")
...
def higher_area(shape_1, shape_2):
    ...
    if area_1 > area_2:
        print(f"{shape_1}'s area is bigger than {shape_2}'s area.")
    elif area_2 > area_1:
        print(f"{shape_2}'s area is bigger than {shape_1}'s area.")
    elif area_1 == area_2:
